    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-400 via-red-500 to-yellow-600 flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="text-center z-10">
        ...
        <button
          ...
          className="bg-purple-400 hover:bg-purple-500 text-black font-bold py-6 px-12 text-2xl shadow-2xl transform hover:scale-110 transition-all duration-200 active:scale-95 border-4 border-purple-600 hover:border-purple-700"
        >
          FART
        </button>
